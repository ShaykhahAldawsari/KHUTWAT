...
questions = [
    "😀 أحب أكون محور الانتباه في الجمعات.",
    "💬 ما أتكلم كثير وأميل للسكوت والكتمان.",
    "🤗 أرتاح إذا كنت حول الناس.",
    "🕶️ أفضل أجلس في الخلفية بعيد عن الانتباه.",
    "💬 دايم أبدأ المحادثات مع الناس.",
    "🤐 ما يكون عندي كلام كثير أقوله في أعلب الأوقات.",
    "👥 أحب أتكلم مع ناس مختلفين في الجمعات والمؤتمرات.",
    "🫥  ما أحب ألفت الانتباه لنفسي. وأندمج مع الحشد",
    "🌟 عادي عندي أكون محور الاهتمام.",
    "🤐  أكون هادئ إذا كنت مع ناس ما أعرفهم وما أهوجس.",
    "😰 أتوتر بسرعة في بعض المواقف.",
    "🧘‍♂️ أغلب الوقت أكون مسترخي ورايق.",
    "😟 أقلق كثير على الأمور اللي تهمني.",
    "🙂 نادرًا ما أحس بالكآبة، وأميل كثير للتفاؤل.",
    ...
    "🧹 مهما حاولت دايم أفشل أرتب أموري.",
    "🚀 أحب أنجز شغلي بسرعة وبدون تأخير.",
    "🗂️ أنسى أرجع الأشياء مكانها أحيانًا.",
    "📚  أحب النظام وارتب كل شيء العشوائية تزعجني",
    ...
    "💭 ما أهتم كثير بالأفكار المجردة والافتراضات.",
    "💡 عندي أفكار رائعة تطويرية وأحب أشاركها.",
    "🛑 ما أمتلك خيال واسع دائمًا، أشوف الأمور أبيض وأسود.",
    "⚡ أفهم الأمور بسرعة وأستوعبها بسهولة.",
    "📝 أحب أستخدم كلمات معبرة أحيانًا وأميل للشاعريه.",
    "🤔 أحب أفكر وأتأمل في الأشياء اللي تهمني.",
    "🎨 دايم عندي أفكار جديدة وأحب الإبداع والتفكير خارح الصندوق."
]
